...
const items = [
  ...
  {
    image: "/assets/sports/football/Football.svg",
    title: "Football",
              ...
              <div className="flex flex-col gap-13 py-8">
                <div>
                  ...
                  <p className="mt-4 max-w-xl text-sm leading-relaxed text-slate-200/80 md:text-base">
                    General Championship (GC) brings together the best teams and
                    athletes for an electrifying showdown of skill, passion and
                    sportsmanship. Track points, cheer your team, and witness
                    history being made.
                  </p>
                </div>
        ...
        <section className="space-y-6 pb-4">
          ...
          <div className="grid gap-6 md:grid-cols-3">
            {items.map((item) => (
              <SpotlightCard
                key={item.title}
                spotlightColor="rgba(139, 76, 39, 0.2)"
